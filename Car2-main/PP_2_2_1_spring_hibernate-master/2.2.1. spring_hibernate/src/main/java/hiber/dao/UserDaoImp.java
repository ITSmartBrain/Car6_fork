...
public class UserDaoImp implements UserDao {
   ...
   public User findOwner(String car_name, String car_series) {
      ...
      return null; //если убираю то не работает public User findOwner(String car_name, String car_series) {return userDao.findOwner(car_name, car_series);
   }
}
